...
1. Download and install [GIT](https://git-scm.com/downloads), [NodeJs](https://nodejs.org/en/) on your computer
...
8. Finally Run `npm dev` to start the server. You now have a running copy of Author's Haven application :sparkles:
...
####
## CREDITS: iVY TEAM [text](https://link) THEIR REPO HERE
